<template>
  <div class="optimize-kannada">
      <v-container grid-list-xl class="text-md-center" style="min-width:100%">

        <h2 style="text-transform:uppercase"> {{selected_taluka}} ತಾಲ್ಲೂಕಿನ Fertilizer ಪಟ್ಟಿ </h2>
  ...
  export default {
    ...
    data () {
      return {
        ...
        optimized_headers: [
          { text: 'Fertilizer ಹೆಸರು',align: 'center',value: 'fertilizer_name'},
          { text: 'ಒಂದು ರಸಗೊಬ್ಬರ ಚೀಲದ ತೂಕ (ಕಿಲೊ)', value: 'fertilizer_bag_weight',align:'center'},
          { text: 'ರಸಗೊಬ್ಬರ ಪ್ರಮಾಣ (ಕಿಲೊ)', value: 'fertilizer_quantity_kg',align:'center'},
          { text: 'ರಸಗೊಬ್ಬರ ಪ್ರಮಾಣ (ಚೀಲಗಳು)', value: 'fertilizer_bag_required',align:'center'}
        ],
        NPK_deficit:{
          N_deficit:0,
          P_deficit:0,
        ...
        dialog: false,
        headers: [
          { text: 'Fertilizer ಹೆಸರು',align: 'center',value: 'fertilizer_name',textcolor:"primary"},
          { text: 'ಒಂದು ರಸಗೊಬ್ಬರ ಚೀಲದ ತೂಕ (ಕಿಲೊ)', align: 'center', value: 'bag_weight_kg' },
          { text: 'ಚೀಲ ವೆಚ್ಚ (INR)', align: 'center',sortable: true, value: 'bag_cost_INR' },
